...
<section id="main">
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="list-group">
                    ...
                    <a href="parent.php" class="list-group-item list-group-item-action"><i
                            class="fas fa-list-alt m-1"></i>Mother</a>
                    <a href="father.php" class="list-group-item list-group-item-action active"><i
            ...
            <div class="col-md-9">
                ...
                <div class="jumbotron jumbotron-fluid">
                    <a href="fatherform.php" class="btn"><i class="fas fa-plus m-1"></i></i>Add New Father
                    </a>
                    <div class="container">
 ...
 $levels=father();
  foreach($levels as $district){ ?>
                                <tr>
                                    <td><?php echo $district->fatherid;?></td>
                                    <td><?php echo $district->vid;?></td>
                                    <td><?php echo $district->fname;?></td>
                                    <td><?php echo $district->age;?></td>


                                    <td>
                                        <a class="btn btn-secondary"
                                            href='editfather.php?u=<?php echo $district->fatherid; ?>'
                                    ...
                                    <td>
                                        <!-- <a class="btn btn-danger"
                                            href='register.php?d=<?php echo $district->fatherid; ?>' title='View Record'
                                            data-toggle='tooltip'>
